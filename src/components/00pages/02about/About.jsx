  ...
  return (
    <main className="about-main">
      ...
      <p>
        ...
        Card Game. Whether you`re a seasoned player, a collector, or a beginner
      ...
      <p>
        ...
        hesitate to contact us. We value your input and are dedicated to making
        this site the best resource for Pokémon TCG fans worldwide.
      </p>
      ...
      <ul>
        <li>
          Facebook:
          <a href="https://www.facebook.com/pokemontcgwebsite">
            facebook.com/pokemontcgwebsite
          </a>
        </li>
        <li>
          Twitter:
          <a href="https://twitter.com/pokemontcgweb">
            twitter.com/pokemontcgweb
          </a>
        </li>
        <li>
          Instagram:
          <a href="https://www.instagram.com/pokemontcgwebsite">
